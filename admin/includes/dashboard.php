    ...
    <div class="row match-height">
        <div class="col-xl-4 col-md-6 col-sm-12">
            <div class="card" style="height: 440px;">
                <div class="card-body">
                    <img class="card-img-top img-fluid" src="../assets/admin_assets/app-assets/images/carousel/05.jpg" alt="Card image cap">
                    <div class="card-block">
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item">
                                <img src="../assets/admin_assets/app-assets/images/carousel/02.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item active">
                                <img src="../assets/admin_assets/app-assets/images/carousel/03.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img src="../assets/admin_assets/app-assets/images/carousel/01.jpg" alt="Third slide">
                            </div>
                        </div>
