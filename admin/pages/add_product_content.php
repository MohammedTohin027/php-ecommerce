    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h2 class="card-title" id="basic-layout-form-center">Add Product Form</h2>
                    ...
                    <form class="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 offset-md-3">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="eventInput1" class="form-control" placeholder="Product Name" name="product_name" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="eventInput1" class="form-control" placeholder="Product Price" name="product_price" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Price">
                                    </div>
                                    <div class="form-group">
                                        <label for="eventInput1">Product Quantity</label>
                                        <input type="number" id="eventInput1" class="form-control" placeholder="Product Quantity" name="product_quantity" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Quantity">
                                    </div>
                                    <div class="form-group">
                                        <label for="eventInput1">Product Sku</label>
                                        <input type="number" id="eventInput1" class="form-control" placeholder="Product Sku" name="product_sku" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Sku">
                                    </div>
                                    <div class="form-group">
                                        <label for="issueinput8">Product Short Description</label>
                                        <textarea id="issueinput8" rows="5" class="form-control" name="product_short_description" placeholder="Product Short Description" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Short Description"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="issueinput8">Product Long Description</label>
                                        <textarea id="issueinput8" rows="5" class="form-control" name="product_long_description" placeholder="Product Long Description" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Product Long Description"></textarea>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="form-actions center">
                            <button name="btn" type="submit" class="btn btn-primary">
                                <i class="icon-check2"></i> Save Product
                            </button>
